...
{		
	...
	$mysqli->query("INSERT INTO media(title, image, video_type, vine_mp4, video_url, video_embed, type, catid, uid, date, active) VALUES ('$FileTitle','$VineImage','$VideoType','$VineURL','$SubmitURL','$VineEmbed','$Type','$Catagory','$Uid','$Date','$Active')") or die (mysqli_error());
...
//Insert other videos
		$mysqli->query("INSERT INTO media(title, image, thumb, video_type, video_url, video_embed, type, catid, uid, date, active) VALUES ('$FileTitle','$LargeThumb','$SmallThumb','$host','$SubmitURL','$EmbedCode','$Type','$Catagory','$Uid','$Date','$Active')") or die (mysqli_error());
