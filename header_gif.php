...
<head>
<meta charset="utf-8">
<title>GIF | <?php echo $settings['name']; ?></title>
<meta name="description" content="<?php echo $settings['descrp']; ?>" />
<meta name="keywords" content="<?php echo $settings['keywords']; ?>" />

<!--Facebook Meta Tags-->
<meta property="fb:app_id"          content="<?php echo $settings['fbapp']; ?>" /> 
<meta property="og:url"             content="http://<?php echo $settings['siteurl']; ?>/gif.html" /> 
<meta property="og:title"           content="Funny GIF | <?php echo $settings['name'];?>" />
...
<div class="center-header">
<div class="header-bottom-left"><div id="channel">GIF</div>
