<?php include ('header_category.php');?>
...
if($LatestSql = $mysqli->query("SELECT * FROM media WHERE catid='$cid' and active=1 ORDER BY id DESC LIMIT 0, 10")){
...
?>
		...
		<nav id="page-nav"><a href="data_category.php?page=2&amp;cid=<?php echo $cid;?>"></a></nav>
