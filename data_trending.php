...
if($LatestSql = $mysqli->query("SELECT * FROM media WHERE active=1 ORDER BY time_viewed DESC LIMIT $start, 10")){
...
?>
		...
		<nav id="page-nav"><a href="data_trending.php?page=2"></a></nav>
