...
<li class="active"><span><a href="profile-<?php echo $pid;?>-<?php echo $ProfileUsername;?>.html">Posts</a></span></li> 
...
if($LatestSql = $mysqli->query("SELECT * FROM media WHERE active=1 and uid='$pid' ORDER BY id DESC LIMIT $start, 10")){
