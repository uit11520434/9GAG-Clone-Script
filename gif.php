...
if($LatestSql = $mysqli->query("SELECT * FROM media WHERE type=2 and active=1 ORDER BY id DESC LIMIT 0, 10")){
...
?>
		...
		<nav id="page-nav"><a href="data_gif.php?page=2"></a></nav>
