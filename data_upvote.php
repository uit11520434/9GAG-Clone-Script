...
<li class="active"><span><a href="upvote-<?php echo $pid;?>-<?php echo $ProfileUsername;?>.html">Up Votes</a></span></li>
<li><span><a href="comments-<?php echo $pid;?>-<?php echo $ProfileUsername;?>.html">Comments</a></span></li>
</ul>
...
if($LatestSql = $mysqli->query("SELECT * FROM voteip LEFT JOIN media ON voteip.media_id=media.id WHERE voteip.uid='$pid' ORDER BY voteip.id and voteip.type=1 DESC LIMIT $start, 10")){
...
?>
		...
		<nav id="page-nav"><a href="data_upvote.php?page=2&id=<?php echo $pid;?>"></a></nav>
