...
<head>
<meta charset="utf-8">
<title><?php echo ucfirst($ProfileRow['username']);?> Profile | <?php echo $settings['name']; ?></title>
<meta name="description" content="<?php echo $settings['descrp']; ?>" />
<meta name="keywords" content="<?php echo $settings['keywords']; ?>" />

<!--Facebook Meta Tags-->
<meta property="fb:app_id"          content="<?php echo $settings['fbapp']; ?>" /> 
<meta property="og:url"             content="http://<?php echo $settings['siteurl'];?>/profile-<?php echo $ProfileRow['uid'];?>-<?php echo $ProfileUsername;?>.html" /> 
<meta property="og:title"           content="<?php echo ucfirst($ProfileRow['username']);?> Profile | <?php echo $settings['name'];?>" />
<meta property="og:description" 	content="<?php echo $ProfileRow['about'];?>" /> 
<?php	if (empty($ProfileImage)){ ?>
<meta property="og:image"           content="http://<?php echo $settings['siteurl']; ?>/images/default-avatar.png" />
<?php }else{?>
